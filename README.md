...
ใช้ NewsAPI ในการดึงข่าว ใช้ฟังก์ชันหลักสองตัวคือ fetchnews สำหรับดึงข่าวตามหมวดหมู่ และ searchNews สำหรับค้นหาข่าวโดยใช้คำค้น โดยจะส่งค่าต่าง ๆ เช่น category, query, page และ pageSize ไปกับพารามิเตอร์ ตัวอย่างเช่น ถ้าจะดึงข่าวเทคโนโลยีหน้าแรก จะส่ง category เป็น technology, page เป็น 1 และ pageSize เป็น 20
